...
describe('Users API resource', function() {
	...
	describe('POST endpoint', function() {
		...
		it('should login an existing user, return a JWT and access the protected user compositions endpoint', function() {
			const tokenUser = {
				username: 'jason',
			...
			.then(function(res) {
				...
				.then(function(tokenRes) {
					...
					return chai.request(app)
					.post('/compositions')
					.send(pastComposition)
					.then(function(compositionRes) {
						let token = tokenRes.body.authToken;
						return chai.request(app)
						.get('/compositions/currentuser')
